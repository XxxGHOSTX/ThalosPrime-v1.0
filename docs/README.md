# Thalos Prime Documentation

This directory contains comprehensive documentation for Thalos Prime.

## Available Documentation

### [session.md](session.md)
Complete guide to session management including:
- Session lifecycle
- State transitions
...
DevOps automation guide covering:
...
- [API Documentation](https://thalos-prime.readthedocs.io) - Full API reference (when available)

## Quick Links

### Getting Started
1. Install: `pip install thalos-prime`
2. Read [session.md](session.md) for core concepts
3. Try [examples](../examples/) for hands-on learning

### For Contributors
1. Read [CONTRIBUTING](../CONTRIBUTING.md)
2. Check [automation.md](automation.md) for DevOps workflows
3. Follow [CODE_OF_CONDUCT](../CODE_OF_CONDUCT.md)

### For Integrators
1. Review [session.md](session.md) API reference
2. Check example integrations in [examples](../examples/)
3. Read [SECURITY](../SECURITY.md) best practices
