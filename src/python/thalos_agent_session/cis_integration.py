...
class CISIntegration:
    ...
    def notify_state_change(
        self, session: AgentSession, old_state: SessionState, new_state: SessionState
    ) -> Dict[str, Any]:
        """
        ...
        return {"status": "acknowledged", "session_id": session.session_id}

    def request_decision(
        self, session: AgentSession, decision_context: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
    ...
    def report_metrics(self, session: AgentSession, metrics: Dict[str, Any]) -> bool:
        """
