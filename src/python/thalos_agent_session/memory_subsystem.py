...
class MemorySubsystem:
    ...
    def store_working_memory(
        self, session_id: str, key: str, value: Any, metadata: Optional[Dict] = None
    ) -> bool:
        """
    ...
    def retrieve_working_memory(self, session_id: str, key: str) -> Optional[Any]:
        """
    ...
    def store_episodic_memory(self, session_id: str, episode: Dict[str, Any]) -> bool:
        """
    ...
    def retrieve_episodic_memory(
        ...
        """
        session_episodes = [
            e for e in self.episodic_memory if e["session_id"] == session_id
        ]

        return session_episodes[-limit:]

    def store_semantic_memory(self, key: str, concept: Dict[str, Any]) -> bool:
        """
    ...
    def get_session_memory_snapshot(self, session_id: str) -> Dict[str, Any]:
        """
    ...
    def clear_session_memory(self, session_id: str) -> bool:
        ...
        keys_to_remove = [
            k for k in self.working_memory.keys() if k.startswith(f"{session_id}:")
        ]
